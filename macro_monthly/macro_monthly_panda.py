import pandas as pd
df=pd.read_csv('C:\\Users\Zeeshan PC\\Documents\\GitHub\\Python-course\\macro_monthly\\macro_monthly.csv',delimiter=',',parse_dates=[14],date_format={'date_time':'%m-%d-%y'})
# Get info for Full CSV file
print(df.info())
# get discribe
print(df.describe)
# get dtypes
...
# Get Multiple Column
column2=df[['Year','Industrial_Production']]
print(column2)
...
secondrow2=df.loc[:1,'Year']
print(secondrow2)
print()

# Select Multiple Column through slicing
secondrow4=df.loc[:3,['Year','Month']]
print(secondrow4)

# throgh range
secondrow5=df.loc[:3,'Year':'Manufacturers_New_Orders: Durable Goods']
print(secondrow5)

# Now through indexing
index_column=pd.read_csv('C:\\Users\\Zeeshan PC\\Documents\\GitHub\\Python-course\\macro_monthly\\macro_monthly.csv',delimiter=",",parse_dates=[14],date_format={'date_time':'%d-%m-%y'},index_col='Year')
# Whole Table
print(index_column)
# Dtype
